...
PROTOBUF_NAMESPACE_OPEN
template<> ::zrpc::RpcPackage* Arena::CreateMaybeMessage<::zrpc::RpcPackage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace zrpc {

// ===================================================================

class RpcPackage final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:zrpc.RpcPackage) */ {
 public:
  inline RpcPackage() : RpcPackage(nullptr) {}
  ~RpcPackage() override;
  explicit PROTOBUF_CONSTEXPR RpcPackage(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  RpcPackage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  void MergeFrom( const RpcPackage& from) {
    RpcPackage::MergeImpl(*this, from);
  }
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "zrpc.RpcPackage";
  }
  protected:
  explicit RpcPackage(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(class_scope:zrpc.RpcPackage)
 private:
  class _Internal;
...
inline const std::string& RpcPackage::service_name() const {
  // @@protoc_insertion_point(field_get:zrpc.RpcPackage.service_name)
  return _internal_service_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RpcPackage::set_service_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.service_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:zrpc.RpcPackage.service_name)
}
inline std::string* RpcPackage::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:zrpc.RpcPackage.service_name)
  return _s;
}
...
inline std::string* RpcPackage::release_service_name() {
  // @@protoc_insertion_point(field_release:zrpc.RpcPackage.service_name)
...
inline void RpcPackage::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:zrpc.RpcPackage.service_name)
}
...
inline const std::string& RpcPackage::method_name() const {
  // @@protoc_insertion_point(field_get:zrpc.RpcPackage.method_name)
  return _internal_method_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RpcPackage::set_method_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.method_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:zrpc.RpcPackage.method_name)
}
inline std::string* RpcPackage::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:zrpc.RpcPackage.method_name)
  return _s;
}
...
inline std::string* RpcPackage::release_method_name() {
  // @@protoc_insertion_point(field_release:zrpc.RpcPackage.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:zrpc.RpcPackage.method_name)
}

// uint32 arg_size = 3;
inline void RpcPackage::clear_arg_size() {
  _impl_.arg_size_ = 0u;
}
inline uint32_t RpcPackage::_internal_arg_size() const {
  return _impl_.arg_size_;
}
inline uint32_t RpcPackage::arg_size() const {
  // @@protoc_insertion_point(field_get:zrpc.RpcPackage.arg_size)
  return _internal_arg_size();
}
inline void RpcPackage::_internal_set_arg_size(uint32_t value) {
  
  _impl_.arg_size_ = value;
}
inline void RpcPackage::set_arg_size(uint32_t value) {
  _internal_set_arg_size(value);
  // @@protoc_insertion_point(field_set:zrpc.RpcPackage.arg_size)
}
